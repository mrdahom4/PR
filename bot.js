...
client.on("message", (message) => {
  ...
  if (message.content.toLowerCase().startsWith(prefix + `djgdjodjkoh`)) {
  ...
  if (message.content.toLowerCase().startsWith(prefix + `4154541545415415`)) {
...
client.on("message", message => {
    ...
    if(!message.member.hasPermission('MANAGE_ROLES')) return message.channel.send(' **ليس لديك صلاحيات**');
...
╰━━━╯╰╯╰━━━┻━━┻━╯
 ...
 2019 - DvBot Support ©  جميع الحقوق محفوظه لده
**
...
client.on('message', message => { 
    ...
    .setFooter(`DvBot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')
...
client.on('message', async xkiller => {
    ...
    if(xkiller.content.startsWith("تقديم")) {
      ...
      await xkiller.channel.send("**ماذا تبيع**").then(e => {
...
ماذا يبيع: **${lang}**
هل هو امين : **${time}**
ماذا سوف يفعل للسرفر : **${expe}**
من طل النسخه : ${xkiller.author} 
